...
export const testimonialsData = [
    {
        id: 1,
        name: 'Himal Acharya',
        title: 'Founder @Believer Arts',
        text: 
        "Thanks to Sandeep Maddheshiya, my e-commerce art site, Believer Arts, became a reality, propelling my business forward. You guys are the best!",
        image: boy2
    },
    {
        id: 2,
